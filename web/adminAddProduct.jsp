<%-- 
    ...
    Created on : Mar 10, 2020, 3:52:37 PM
    Author     : Admin
--%>
                            ...
                            <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
                                <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                                    ...
                                    <div class="row tm-edit-product-row">
                                            ...
                                            <form action="AdminController" method="POST" class="tm-edit-product-form">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input
                                                        ...
                                                        />
                                                    <font color="red">
                                                    ${requestScope.INVALID.foodNameError}
                                                    </font>
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label
                                                ...
                                                <div class="row">
                                                    <div class="form-group mb-3 col-xs-12 col-sm-6">
                                                        ...
                                                        <input
                                                            ...
                                                            />
                                                        <font color="red">
                                                        ${requestScope.INVALID.createDateError}
                                                        </font>
                                                    </div>
                                                    <div class="form-group mb-3 col-xs-12 col-sm-6">
                                                        <label
                                        ...
                                        <div class="col-12">
                                            <input type="submit" class="btn btn-primary btn-block text-uppercase" name="action" value="Add product"/><%--Add Product Now --%>
                                        </div>
                                        </form>
                                    </div>
                                </div>
